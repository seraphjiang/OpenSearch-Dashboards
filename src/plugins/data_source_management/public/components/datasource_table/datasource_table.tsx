...
import { DataSourceTableItem, DataSourceCreationOption } from '../types';
...
const ariaRegion = i18n.translate('dataSourceManagement.editIndexPatternLiveRegionAriaLabel', {
  defaultMessage: 'Data Sources',
});

const title = i18n.translate('dataSourceManagement.dataSourceTable.title', {
  defaultMessage: 'Data Sources',
});
...
export const DataSourceTable = ({ canSave, history }: Props) => {
  ...
  const [dataSources, setIndexPatterns] = useState<DataSourceTableItem[]>([]);
  ...
  // useEffect(() => {
  //   (async function () {
  //     const options = await dataSourceManagementStart.creation.getIndexPatternCreationOptions(
  //       history.push
  //     );
  ...
  //         docLinksIndexPatternIntro={docLinks.links.noDocumentation.dataSources.introduction}
