#!/bin/bash
# Start OpenSearch Dashboards with EXPLORE configuration
# Use for: Groups 10e-17e (explore tests)
...
echo "========================================="
echo "Starting OSD with EXPLORE Configuration"
echo "========================================="
echo "Node version: $(node --version)"
echo "Configuration: Explore Feature (workspace + data_source + explore)"
echo "Compatible with: Groups 10e-17e (explore tests)"
echo "========================================="
echo ""
...
# Start OSD with explore configuration
echo "Starting OpenSearch Dashboards with Explore UI..."
echo ""
